...
export default function About({diapo}){
    return(
        <section className={`h-full mx-auto w-full flex flex-col xl:justify-center items-start xl:items-start notLaptop:-mt-[100px]`}>
            <div className="max-w-[1100px] xl:flex xl:flex-col xl:justify-center h-full mx-auto overflow-y-scroll md:overflow-y-hidden relative ">
                ...
                <div className="w-full flex flex-col xl:flex-row justify-start items-center xl:items-start overflow-y-scroll scrollbar-none 2xl:overflow-y-hidden  xl:space-y-0 xl:space-x-[50px] px-6 relative ">
